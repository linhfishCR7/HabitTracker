...
Daily habit tracking with streak counters, reminders, and progress visualization

## 📱 App Information

- **Package Name:** `com.lehau.HabitTracker`
...
1. Clone this repository:
   ```bash
   git clone https://github.com/linhfishCR7/HabitTracker.git
   cd HabitTracker
   ```
